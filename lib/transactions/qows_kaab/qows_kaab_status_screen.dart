...
class QowsKaabStatusScreen extends StatefulWidget {
  ...
  @override
  State<QowsKaabStatusScreen> createState() => _QowsKaabStatusScreenState();
}

class _QowsKaabStatusScreenState extends State<QowsKaabStatusScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailRow('Application Number', _application!['application_number']?.toString()),
                _buildDetailRow('Credit Limit', '\$${_application!['credit_limit']}'),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            title: Text('Application #${app['application_number'] ?? app['id']}'),
            subtitle: Text('Credit Limit: \$${app['credit_limit']}'),
            trailing: Container(
