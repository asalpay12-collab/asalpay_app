...
// Get the token
  ...
  Future<List<TransferOperationModel>> fetchAndSetTopUpBankAccounts() async {
    ...
    try {
      ...
      print(response.body);
      if (checkAndHandleSessionExpiry(response.statusCode, response.body)) return _FillTopupAccount;
      if (response.statusCode == 200) {
  ...
  Future<List<TransferOperationModel>> fetchAndSetFillFundMovingCustomerCurrency(
    ...
    try {
      ...
      // _province.clear();
      print(response.body);
      if (checkAndHandleSessionExpiry(response.statusCode, response.body)) return _FundMovingFillCustomerCurrency;
      if (response.statusCode == 200) {
  ...
  Future<List<TransferOperationModel>> fetchAndSetFillFundMovingAccountSaving(
    ...
    try {
      ...
      // _province.clear();
      print(response.body);
      if (checkAndHandleSessionExpiry(response.statusCode, response.body)) return _FillFundMovingAccountSaving;
      if (response.statusCode == 200) {
 ...
 // todo:saving ExchangeData
  ...
  Future<List<TransferOperationModel>> fetchAndSetfillmerchantinfo(
    ...
    try {
      ...
      // _province.clear();
      print(response.body);
      if (checkAndHandleSessionExpiry(response.statusCode, response.body)) return _FillmerchantInfo;
      if (response.statusCode == 200) {
  ...
  Future<List<TransferOperationModel>> fetchAndSetMerchantCusAccountCurrency(
    ...
    try {
      ...
      // _province.clear();
      print(response.body);
      if (checkAndHandleSessionExpiry(response.statusCode, response.body)) return _MerchantCusAccountCurrency;
      if (response.statusCode == 200) {
