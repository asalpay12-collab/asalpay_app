      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              final androidUrl =
                  'https://play.google.com/store/apps/details?id=com.asal.asalpay';
              final iosUrl =
                  'https://apps.apple.com/ug/app/asal-pay/id6502257400';
...
// backgroundColor: secondryColor.withOpacity(0.1),
  ...
  Future<void> _submit(BuildContext context) async {
    ...
    try {
      ...
      await Provider.of<Auth>(context, listen: false).login(_authData['phone'],
          _authData['password'], _authData['version'], context);
      ...
      final List<HomeSliderModel> sliderImages =
...
// 4) Prefetch slider images into cache so HomeScreen shows immediately
      ...
      subscription = homeSliderAndTransactionProvider
          .fetchAndDisplayBalance(walletAccountsId)
          .listen((balances) {
      ...
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(
          builder: (_) => HomeScreen(
            ...
            initialHomeBalance:
                balanceSeed, // <- use the seed you just computed
            initialHomeTransaction: homeCurrentTransaction ??
