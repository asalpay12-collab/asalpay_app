...
/// 252pay notifications destination.
/// Shows saved 252pay (ChatMsg) notifications so you can view and debug.
class Pay252NotificationsScreen extends StatelessWidget {
  static const routeName = '/notifications/252pay';

  const Pay252NotificationsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              await NotificationStore.clear252pay();
              if (context.mounted) {
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: NotificationStore.get252payList(),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Markaad test notification-ka taabato, halkan ayey u soo baxaan.',
                      textAlign: TextAlign.center,
